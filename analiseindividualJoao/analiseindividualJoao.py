...
grf.plotar_histograma_com_filtro(ae.df_final, 'ORÇAMENTO REALIZADO (R$)', 'EXERCÍCIO', title="Histograma de gastos em educação")
grf.plotar_histograma_com_filtro(ae.df_sem_outliers, 'ORÇAMENTO REALIZADO (R$)', title="Histograma de gastos em educação")
...
df_final = grf.substituir_coluna_por_lista_especificada(ae.df_final, "NOME SUBFUNÇÃO", 'OUTROS', ['Outros encargos especiais',
...
grf.plotar_histograma_com_filtro(df_sem_outliers, 'ORÇAMENTO REALIZADO (R$)', 'EXERCÍCIO', 2017, title="Histograma de gastos em educação em 2017")
grf.plotar_histograma_com_filtro(df_sem_outliers, 'ORÇAMENTO REALIZADO (R$)', 'EXERCÍCIO', 2016, title="Histograma de gastos em educação em 2016")
grf.plotar_histograma_com_filtro(df_sem_outliers, 'ORÇAMENTO REALIZADO (R$)', 'EXERCÍCIO', 2015, title="Histograma de gastos em educação em 2015")
grf.plotar_histograma_com_filtro(df_sem_outliers, 'ORÇAMENTO REALIZADO (R$)', 'EXERCÍCIO', 2014, title="Histograma de gastos em educação em 2014")
